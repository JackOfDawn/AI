...
public:
	...
	Steering( const Vector2D& theLinear = gZeroVector2D, float theAngular = 0.0f, bool applyLinearDirectly = false, bool applyAngularDirectly = false ):mLinear(theLinear),mAngular(theAngular),mApplyLinearDirectly(applyLinearDirectly),mApplyAngularDirectly(applyAngularDirectly) {};
	Steering( const Steering& rhs ):mLinear(rhs.mLinear), mAngular(rhs.mAngular), mApplyLinearDirectly(rhs.mApplyLinearDirectly), mApplyAngularDirectly(rhs.mApplyAngularDirectly){};
	~Steering(){};
	...
	bool shouldApplyLinearDirectly() const { return mApplyLinearDirectly; };
	bool shouldApplyAngularDirectly() const { return mApplyAngularDirectly; };
	void setApplyAngularDirectly( bool val ) { mApplyAngularDirectly = val; };
...
protected:
	...
	bool mApplyLinearDirectly;
	bool mApplyAngularDirectly;
