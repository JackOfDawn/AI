...
void KinematicUnit::update(float time)
{
	...
	if( steering->shouldApplyLinearDirectly() )
	{
		//not stopped
...
void KinematicUnit::align( KinematicUnit* pTarget )
{
	AlignSteering* pAlignSteering = new AlignSteering( this, gpGame->getUnitManager()->getUnit(0)->getOrientation() );
