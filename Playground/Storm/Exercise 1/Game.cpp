...
bool Game::init()
{
	...
	mpUnitManager->createAIUnit(pEnemyArrow, pos2, 1, vel2, 0.0f, 180.0f, 100.0f, DYNAMIC_ARRIVE);
	...
	mpUnitManager->createAIUnit(pEnemyArrow, pos3, 1, vel2, 0.0f, 180.0f, 100.0f, DYNAMIC_SEEK);
