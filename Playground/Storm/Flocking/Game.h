...
const IDType LARGE_ASTEROID_ID = 3;
const IDType MEDIUM_ASTEROID_ID = 4;
const IDType SMALL_ASTEROID_ID = 5;
...
public:
	...
	inline std::vector<Wall> getWalls() const { return mVectorWalls; };
...
private:
	...
	IDType mLargeAsteroidID;
	IDType mMediumAsteroidID;
	IDType mSmallAsteroidID;
